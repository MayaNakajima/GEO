...
統合日：2026年7月14日（v4・v5を1ファイルに統合。内容差分を確認のうえ、v4の記載はすべてv5に包含されていることを確認済み）
...
*統合版（2026-07-14）：v4・v5を1ファイルに統合。差分確認の結果、v4固有の記載は存在せず、v5の内容がv4を完全に包含していたため、本ファイルはv5相当の内容を正本として作成。*
